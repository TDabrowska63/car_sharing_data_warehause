...
--11. Podaj top 3 najczêœciej wypo¿yczanych marek samochodów w obserwowanym czasie
Select [Measures].[Liczba wypozyczen] On Columns,
	TopCount([Dim Samochod].[Marka].members, 4, [Measures].[Liczba wypozyczen]) On Rows
	from [Fakty Wypozyczenia];